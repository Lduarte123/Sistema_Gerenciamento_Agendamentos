...
class VisualizarFrame(ctk.CTkFrame):  # visualização em treeview
    ...
    def atualizar_tabela(self, agendamentos=None):
        ...
        for agendamento in agendamentos_pagina:
            ...
            self.tree.insert('', 'end', values=(agendamento.id, agendamento.nome, data_formatada, horario_formatado, agendamento.local, agendamento.descricao, agendamento.status if agendamento.descricao else "N/A"))  # Exibe "N/A" se descrição for vazia
